...
import com.owner.baselibrary.injection.qualifier.ActivityFragmentManager
...
/**
 *提供Activity实例即Activity级的context
...
class ActivityModule(private val activity: AppCompatActivity) {
    ...
    @ActivityScope
    @ActivityContext
    internal fun provideActivityContext(): AppCompatActivity = activity
