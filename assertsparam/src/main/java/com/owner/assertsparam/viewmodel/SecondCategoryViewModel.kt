...
import com.owner.assertsparam.data.ThirdCategoryInfo
 ...
 * @description:
 */
class SecondCategoryViewModel : BaseViewModel<AssertsParamRepository>() {



     var secondCgList= ObservableArrayList<ThirdCategoryInfo>()
